...
class SettingsController extends Controller
{
	...
	public function update(Request $request, $id)
	{
		...
		$settings->email                  = $request->store_email;
		$settings->phone                  = $request->store_phone;
		...
		$settings->products_items_per_page      = $request->products_items_per_page ||2;
		$settings->products_items_size_h        = $request->products_items_size_h  ||2;
		$settings->products_items_size_w        = $request->products_items_size_w ||2;
		$settings->facebook_link                = $request->facebook_link  ||2;
		$settings->instagram_link               = $request->instagram_link  ||2;
		$settings->twitter_link                 = $request->twitter_link  ||2;
