   ...
   <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
         <ul class="navbar-nav">
            ...
            <li class=" nav-item">
               <a class="nav-link text-white  {{ $helper->active_link(['appointments']) }}" href="/admin/appointments">
                  <i class="material-symbols-outlined opacity-10">book_online</i>
                  <span class="nav-link-text ms-2 ps-1"> Appointments </span>
               </a>
            </li>
          
            <li class=" nav-item">
               <a class="nav-link text-white  {{ $helper->active_link(['attributes']) }}" href="/admin/attributes">
                  <i class="material-symbols-outlined opacity-10">user_attributes</i>
      
                  <span class="nav-link-text ms-2 ps-1"> Attributes </span>
               </a>
            </li>
