			...
			<!-- <div class="container">
					<div class="row justify-content-center py-2">
						<div class="col-9 col-md-12 text-center">
							<p class="text-color-light mb-0"><strong>DEAL OF THE WEEK</strong> - Free Diagnosis & Break vks - <strong><a href="#" class="text-color-light text-decoration-none custom-text-underline-1">Make an Appointment</a></strong></p>
						</div>
					</div>
				</div> -->
		</div>
									...
									<nav class="header-nav-top">
										<ul class="header-social-icons social-icons social-icons-clean social-icons-icon-gray social-icons-medium custom-social-icons-divider">
											<li class="social-icons-facebook">
												<a href="https://www.facebook.com/profile.php?id=61563688082628" rel="noreferrer" target="_blank" title="Facebook">
											...
											<li class="social-icons-linkedin">
												<a href="https://www.instagram.com/autoglass.ng?igsh=MWRwb3YwY3FxeGdiNQ%3D%3D&utm_source=qr" rel="noreferrer" target="_blank" title="Linkedin">
